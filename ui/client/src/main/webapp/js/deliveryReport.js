			...
			$http({
	        	...
	        	if(data.error=="true"){
                    ...
                    var results=JSON.parse(data.result);
	        		   ...
	        		   $scope.smsDeliveryData+=' <div class="portlet box green">';
	        		   $scope.smsDeliveryData+='      <div class="portlet-title">';
	        		   $scope.smsDeliveryData+='          <div class="caption">';
	        		   $scope.smsDeliveryData+='             <!--  <i class="fa fa-cogs"></i> -->SMS Delivery Report </div>';
	        		   $scope.smsDeliveryData+='      </div>';
	        		   $scope.smsDeliveryData+='      <div class="portlet-body flip-scroll">';

	        		   $scope.smsDeliveryData+=" <table class='table table-bordered table-striped table-condensed flip-content' >";
	        		   $scope.smsDeliveryData+="     <thead class='flip-content'>";
